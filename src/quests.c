...
static const u8 gText_Quests[] = _("   Side\n Quests");
static const u8 gText_QuestMenu_Begin[] = _("Begin");
static const u8 gText_QuestMenu_End[] = _("End");
static const u8 gText_QuestMenu_Details[] = _("Details");
static const u8 gText_QuestMenu_Reward[] = _("Reward");
static const u8 gText_QuestMenu_Unk[] = _("{COLOR}{LIGHT_GRAY}?????????");
static const u8 gText_QuestMenu_Active[] = _("{COLOR}{GREEN}Active");
static const u8 gText_QuestMenu_Complete[] = _("{COLOR}{BLUE}Done");
static const u8 gText_QuestMenu_Exit[] = _("Exit the Quest Menu");
static const u8 gText_QuestMenu_SelectedQuest[] = _("Do what with\nthis quest?");
static const u8 gText_QuestMenu_DisplayDetails[] = _("POC: {STR_VAR_1}\nMap: {STR_VAR_2}");
static const u8 gText_QuestMenu_DisplayReward[] = _("Reward:\n{STR_VAR_1}");
static const u8 gText_QuestMenu_BeginQuest[] = _("Initiating Quest:\n{STR_VAR_1}");
static const u8 gText_QuestMenu_EndQuest[] = _("Cancelling Quest:\n{STR_VAR_1}");
...
{
    {gText_QuestMenu_Begin,             {.void_u8 = Task_QuestMenuBeginQuest}},
    {gText_QuestMenu_Details,           {.void_u8 = Task_QuestMenuDetails}},
...
{
    {gText_QuestMenu_End,               {.void_u8 = Task_QuestMenuEndQuest}},
    {gText_QuestMenu_Details,           {.void_u8 = Task_QuestMenuDetails}},
    {gText_Cancel,                      {.void_u8 = Task_QuestMenuCancel}},
};
...
{
    {gText_QuestMenu_Reward,            {.void_u8 = Task_QuestMenuReward}},
    {gText_QuestMenu_Details,           {.void_u8 = Task_QuestMenuDetails}},
    {gText_Cancel,                      {.void_u8 = Task_QuestMenuCancel}},
};
...
static void QuestMenu_BuildListMenuTemplate(void)
{
    ...
    for (i = 0; i < sStateDataPtr->nItems; i++)
    {
        if (GetSetQuestFlag(i, FLAG_GET_UNLOCKED))
            ...
            sListMenuItems[i].name = gText_QuestMenu_Unk;
...
static void QuestMenu_ItemPrintFunc(u8 windowId, u32 itemId, u8 y)
{
    ...
    if (itemId != LIST_CANCEL)
    {
        if (GetSetQuestFlag(itemId, FLAG_GET_COMPLETED))
            StringCopy(gStringVar4, gText_QuestMenu_Complete);
        else if (IsActiveQuest(itemId))
            StringCopy(gStringVar4, gText_QuestMenu_Active);
        else
            StringCopy(gStringVar4, gText_Empty);
...
static void QuestMenu_PrintHeader(void)
{
    QuestMenu_AddTextPrinterParameterized(2, 0, gText_Quests, 0, 1, 0, 1, 0, 0);
}
...
static void Task_QuestMenuSubmenuInit(u8 taskId)
{
    ...
    StringCopy(gStringVar4, gText_QuestMenu_SelectedQuest);
    //StringExpandPlaceholders(gStringVar4, gText_QuestMenu_SelectedQuest);
...
static void Task_QuestMenuDetails(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_QuestMenu_DisplayDetails);
...
static void Task_QuestMenuReward(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_QuestMenu_DisplayReward);
    QuestMenu_DisplaySubMenuMessage(taskId);
}
...
static void Task_QuestMenuEndQuest(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_QuestMenu_EndQuest);
    QuestMenu_DisplaySubMenuMessage(taskId);
}
...
static void Task_QuestMenuBeginQuest(u8 taskId)
{
    ...
    QuestMenuSubmenuSelectionMessage(taskId);
    StringCopy(gStringVar1, sSideQuests[questIndex].name);
    StringExpandPlaceholders(gStringVar4, gText_QuestMenu_BeginQuest);
    QuestMenu_DisplaySubMenuMessage(taskId);
}
