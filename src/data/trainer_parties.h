...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_SPARK, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_ROCK_TOMB, MOVE_CURSE, MOVE_SAND_TOMB, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 200,
    .lvl = 14,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_YAWN, MOVE_EMBER, MOVE_SMOG, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_DOUBLE_KICK, MOVE_PURSUIT, MOVE_AERIAL_ACE, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 23,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_ROLLING_KICK, MOVE_DETECT, MOVE_FAKE_OUT, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_FAKE_OUT, MOVE_VITAL_THROW, MOVE_KNOCK_OFF, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 25,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .abilityNums = 0,
    .moves = {MOVE_SPIRIT_BREAK, MOVE_KARATE_CHOP, MOVE_TICKLE, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 10,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_MUD_SLAP, MOVE_DEFENSE_CURL}
    },
    {
    .iv = 100,
    .lvl = 10,
    .species = SPECIES_ARON,
    .moves = {MOVE_HARDEN, MOVE_MUD_SLAP, MOVE_HEADBUTT, MOVE_METAL_CLAW}
    }
};
